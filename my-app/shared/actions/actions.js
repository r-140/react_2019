...
export const LOAD_BY_FILTER_SUCCESS = "loadByFilter_success";
export const LOAD_BY_FILTER_ERROR = "loadByFilter_error";
...
export function loadByFilterError(error) {    
    return {type: LOAD_BY_FILTER_ERROR, error: error}
}

export function loadByFiltersSuccess(data) {    
    return {type: LOAD_BY_FILTER_SUCCESS, payload: data}
}
